...
public:
  ...
  uint32_t getFlags() const;
   ...
   int64_t getPrimeCount() const;
   int64_t getTwinCount() const;
   int64_t getTripletCount() const;
   int64_t getQuadrupletCount() const;
   int64_t getQuintupletCount() const;
   int64_t getSextupletCount() const;
   int64_t getSeptupletCount() const;

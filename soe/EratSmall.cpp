  ...
  for (Bucket_t* bucket = bucketList_; bucket != NULL; bucket = bucket->next) {
    ...
    for (; wPrime != end; wPrime++) {
      ...
      switch (wPrime->getWheelIndex()) {
        ...
        for (;;) {
          case 1: *s &= BIT0; s += primeX6 + 1; if (s >= sieveEnd) goto out1;
          case 2: *s &= BIT4; s += primeX4 + 1; if (s >= sieveEnd) goto out2;
          case 3: *s &= BIT3; s += primeX2;     if (s >= sieveEnd) goto out3;
          case 4: *s &= BIT7; s += primeX4 + 1; if (s >= sieveEnd) goto out4;
          case 5: *s &= BIT6; s += primeX2 + 1; if (s >= sieveEnd) goto out5;
          case 6: *s &= BIT2; s += primeX4 + 1; if (s >= sieveEnd) goto out6;
          case 7: *s &= BIT1; s += primeX6 + 1; if (s >= sieveEnd) goto out7;
          ...
          if (s >= sieveEnd) goto out0;
        }
        // for sieving primes of type i * 30 + 11
        for (;;) {
          case  9: *s &= BIT1; s += primeX6 + 2; if (s >= sieveEnd) goto out1;
          case 10: *s &= BIT3; s += primeX4 + 1; if (s >= sieveEnd) goto out2;
          case 11: *s &= BIT7; s += primeX2 + 1; if (s >= sieveEnd) goto out3;
          case 12: *s &= BIT5; s += primeX4 + 2; if (s >= sieveEnd) goto out4;
          case 13: *s &= BIT0; s += primeX2;     if (s >= sieveEnd) goto out5;
          case 14: *s &= BIT6; s += primeX4 + 2; if (s >= sieveEnd) goto out6;
          case 15: *s &= BIT2; s += primeX6 + 2; if (s >= sieveEnd) goto out7;
        ...
        for (;;) {
          case 17: *s &= BIT2; s += primeX6 + 2; if (s >= sieveEnd) goto out1;
          case 18: *s &= BIT7; s += primeX4 + 2; if (s >= sieveEnd) goto out2;
          case 19: *s &= BIT5; s += primeX2 + 1; if (s >= sieveEnd) goto out3;
          case 20: *s &= BIT4; s += primeX4 + 2; if (s >= sieveEnd) goto out4;
          case 21: *s &= BIT1; s += primeX2 + 1; if (s >= sieveEnd) goto out5;
          case 22: *s &= BIT0; s += primeX4 + 1; if (s >= sieveEnd) goto out6;
          case 23: *s &= BIT6; s += primeX6 + 3; if (s >= sieveEnd) goto out7;
        ...
        for (;;) {
          case 25: *s &= BIT3; s += primeX6;     if (s >= sieveEnd) goto out1;
          case 26: *s &= BIT6; s += primeX4 + 1; if (s >= sieveEnd) goto out2;
          case 27: *s &= BIT0; s += primeX2;     if (s >= sieveEnd) goto out3;
          case 28: *s &= BIT1; s += primeX4;     if (s >= sieveEnd) goto out4;
          case 29: *s &= BIT4; s += primeX2;     if (s >= sieveEnd) goto out5;
          case 30: *s &= BIT5; s += primeX4;     if (s >= sieveEnd) goto out6;
          case 31: *s &= BIT7; s += primeX6 + 1; if (s >= sieveEnd) goto out7;
        ...
        for (;;) {
          case 33: *s &= BIT4; s += primeX6 + 1; if (s >= sieveEnd) goto out1;
          case 34: *s &= BIT2; s += primeX4;     if (s >= sieveEnd) goto out2;
          case 35: *s &= BIT6; s += primeX2 + 1; if (s >= sieveEnd) goto out3;
          case 36: *s &= BIT0; s += primeX4;     if (s >= sieveEnd) goto out4;
          case 37: *s &= BIT5; s += primeX2;     if (s >= sieveEnd) goto out5;
          case 38: *s &= BIT7; s += primeX4 + 1; if (s >= sieveEnd) goto out6;
          case 39: *s &= BIT3; s += primeX6 + 1; if (s >= sieveEnd) goto out7;
        ...
        for (;;) {
          case 41: *s &= BIT5; s += primeX6 + 2; if (s >= sieveEnd) goto out1;
          case 42: *s &= BIT1; s += primeX4 + 1; if (s >= sieveEnd) goto out2;
          case 43: *s &= BIT2; s += primeX2;     if (s >= sieveEnd) goto out3;
          case 44: *s &= BIT6; s += primeX4 + 1; if (s >= sieveEnd) goto out4;
          case 45: *s &= BIT7; s += primeX2 + 1; if (s >= sieveEnd) goto out5;
          case 46: *s &= BIT3; s += primeX4 + 1; if (s >= sieveEnd) goto out6;
          case 47: *s &= BIT4; s += primeX6 + 2; if (s >= sieveEnd) goto out7;
        ...
        for (;;) {
          case 49: *s &= BIT6; s += primeX6 + 3; if (s >= sieveEnd) goto out1;
          case 50: *s &= BIT5; s += primeX4 + 2; if (s >= sieveEnd) goto out2;
          case 51: *s &= BIT4; s += primeX2 + 1; if (s >= sieveEnd) goto out3;
          case 52: *s &= BIT3; s += primeX4 + 2; if (s >= sieveEnd) goto out4;
          case 53: *s &= BIT2; s += primeX2 + 1; if (s >= sieveEnd) goto out5;
          case 54: *s &= BIT1; s += primeX4 + 2; if (s >= sieveEnd) goto out6;
          case 55: *s &= BIT0; s += primeX6 + 2; if (s >= sieveEnd) goto out7;
        ...
        for (;;) {
          case 57: *s &= BIT7; s += primeX6 + 1; if (s >= sieveEnd) goto out1;
          case 58: *s &= BIT0; s += primeX4;     if (s >= sieveEnd) goto out2;
          case 59: *s &= BIT1; s += primeX2;     if (s >= sieveEnd) goto out3;
          case 60: *s &= BIT2; s += primeX4;     if (s >= sieveEnd) goto out4;
          case 61: *s &= BIT3; s += primeX2;     if (s >= sieveEnd) goto out5;
          case 62: *s &= BIT4; s += primeX4;     if (s >= sieveEnd) goto out6;
          case 63: *s &= BIT5; s += primeX6;     if (s >= sieveEnd) goto out7;
